# Generated by Django 2.0.9 on 2018-12-30 12:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', phonenumber_field.modelfields.PhoneNumberField(blank=True, help_text='Enter phone number with country code', max_length=13, null=True)),
                ('email', models.EmailField(blank=True, max_length=254, null=True, verbose_name='Email')),
                ('date_of_birth', models.DateField(blank=True, null=True)),
            ],
            options={
                'permissions': (('add_staff', 'Can add staff'), ('accept_request', 'Can accept leave request'), ('make_request', 'can make leave request'), ('set_roles_of_staff', 'can set roles of staff'), ('view_attendance', 'can veiw attendance')),
                'default_permissions': (),
            },
            managers=[
